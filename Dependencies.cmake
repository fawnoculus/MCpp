...
set_target_properties(glm uninstall
        ...
        PROPERTIES FOLDER "dependencies/glm"
)
...
set_target_properties(glfw update_mappings PROPERTIES FOLDER "dependencies/glfw")
...
if (NOT Vulkan_FOUND)
    message(FATAL_ERROR "[MCpp] Failed to Find Vulkan SDK! Did you set VULKAN_SDK in your Environment Variables?")
endif ()
if (NOT Vulkan_glslang_FOUND)
    message(FATAL_ERROR "[MCpp] Failed to Find glslang in Vulkan SDK!")
endif ()
